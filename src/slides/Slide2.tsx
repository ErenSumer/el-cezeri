        ...
        <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl p-8 shadow-2xl">
          <div className="flex flex-col md:flex-row">
            <motion.div variants={itemVariants} className="flex-grow pr-8">
              <h2 className="text-4xl font-bold mb-6 text-white">Hakkında</h2>
              <p className="text-xl text-gray-300 mb-6">
                El Cezeri, 1136 yılında günümüz Türkiye'sinin Diyarbakır
                bölgesinde doğmuştur. Tam adı İsmail al-Jazari olan El Cezeri,
                ünlü bir mühendis, mucit ve yazar olarak bilinir.
              </p>
            </motion.div>
            <motion.div
          ...
          >
            <div>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-1">
                <li>Fil Su Saati</li>
                <li>Mekanik Oyun ve Eğlence Makineleri</li>
                <li>Kendi Kendine Hareket Eden Müzik Aletleri</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-white mb-2">
              ...
              <p className="text-gray-300">
                El Cezeri’nin çalışmaları, Orta Çağ’da bilim ve mühendislikte
                büyük bir etki yaratmış, modern mühendisliğin temellerinden biri
                olmuştur. Bugün bile onun tasarımları, birçok mühendislik
                disiplinine ilham vermektedir.
              </p>
            </div>
          </motion.div>
        </div>
